...
interface IUsualSP {
    ...
    /// @notice Emitted when the reward period is started
    /// @param amount The amount of Usual tokens distributed.
    /// @param usualXShares The amount of UsualX shares distributed.
    /// @param startTime The start time of the reward period.
    /// @param endTime The end time of the reward period.
    event RewardPeriodStarted(
        uint256 amount, uint256 usualXShares, uint256 startTime, uint256 endTime
    );

    /// @notice Emitted when UsualX is swept to a recipient.
    /// @param recipient The address of the recipient.
    /// @param amount The amount of UsualX swept.
    event UsualXSwept(address indexed recipient, uint256 amount);

    /// @notice Emitted when UsualStar is swept to a recipient.
    /// @param recipient The address of the recipient.
    /// @param amount The amount of UsualStar swept.
    event UsualStarSwept(address indexed recipient, uint256 amount);

    /// @notice Emitted when Usual is swept to a recipient.
    /// @param recipient The address of the recipient.
    /// @param amount The amount of Usual swept.
    event UsualSwept(address indexed recipient, uint256 amount);
    ...
    /// @notice sweep UsualX to a recipient
    /// @dev Can only be called by the admin
    /// @param recipient The address of the recipient
    function sweepUsualX(address recipient) external;

    /// @notice sweep UsualStar to a recipient
    /// @dev Can only be called by the admin
    /// @param recipient The address of the recipient
    function sweepUsualStar(address recipient) external;

    /// @notice sweep Usual to a recipient
    /// @dev Can only be called by the admin
    /// @param recipient The address of the recipient
