    ...
    EIP712Upgradeable
{
    ...
    // Note: We don't need to reinitialize the contract because we are not changing the storage layout
    ...
    /// @notice Sweeps accumulated fees to the distribution module
    ...
    function sweepFees() external nonReentrant returns (uint256) {
        ...
        $.usualToken.safeTransfer(distributionModule, accumulatedFees);
