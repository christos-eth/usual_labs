...
interface IDistributionAllocator {
    ...
    /// @notice Set the fee rates
    /// @param _treasuryFeeRate The treasury fee rate
    /// @param _usualXFeeRate The UsualX fee rate
    function setFeeRates(uint256 _treasuryFeeRate, uint256 _usualXFeeRate) external;

    /// @notice Get the fee rates
    /// @return treasuryFeeRate The treasury fee rate
    /// @return usualXFeeRate The UsualX fee rate
    /// @return burnFeeRate The burn fee rate
